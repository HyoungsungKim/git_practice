...
setup() ->
    ...
    ets:insert(PlanemoTable, #planemo{ name=venus, gravity=8.9, diameter=12104, distance_from_sun=108.2 }),
    ...
    ets:insert(PlanemoTable, #planemo{ name=pluto, gravity=0.6, diameter=2300, distance_from_sun=5913.0 }),
    ets:insert(PlanemoTable, #planemo{ name=haumea, gravity=0.44, diameter=1150, distance_from_sun=6484.0 }),
    ets:insert(PlanemoTable, #planemo{ name=makemake, gravity=0.5, diameter=1500, distance_from_sun=6850.0 }),
    ets:insert(PlanemoTable, #planemo{ name=eris, gravity=0.8, diameter=2400, distance_from_sun=10210.0 }),
